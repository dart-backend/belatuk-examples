...
AngelConfigurer configureServer(FileSystem fileSystem) {
  return (Angel app) async {
    ...
    // using one created by the community, include it in `lib/src/config/config.dart`.
